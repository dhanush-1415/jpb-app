        ...
        <div className="inner-container">
          <div className="container">
            <div className="main-box-wrapper">
             ...
             <div className="forgotp-holder login-holder">
                <form>
                   <div className="main-inner-box">
                    <div className="mx-575">
                    <div className="pageTitle title-fix text-center md"><h2>Forgot Password?</h2></div>
                    ...
                    <div className="row text-center align-items-center justify-content-center form-group">
                        ...
                        <div className="col-lg-auto">
                          <div className="radio-inline">
                            <div className="radio">
                              <label>
                                <input type="radio" name="r1"/> <span>via SMS</span></label>
                            </div>
                            <div className="radio">
                              <label>
                    ...
                    <div className="row mx-730 mt30  justify-content-between">
                      <div className="col-lg-auto">
                        <a className="custom-button prvs">BACK TO LOGIN</a>
                      </div>
                      <div className="col-lg-auto">
